...
export const DefaultProject = ({
  ...
  return (
    <>
      <div
        className="bg-white shadow-lg rounded-lg p-4 border hover:shadow-xl transition-shadow duration-300 ease-in-out w-full max-w-xs cursor-pointer hover:scale-110 hover:transition hover:ease-in-out hover:duration-300"
        onClick={onClick}
      >
      ...
      {isModalVisible && (
        <ModelDialog onClose={() => setIsModalVisible(false)}>
          hello
        </ModelDialog>
      )}
    </>
