        ...
        >
          {user?.avatar ? (
            <div className="user-avatar flex items-center my-3 gap-5">
              <p style={{ minWidth: '120px', textAlign: 'left' }}>Avatar :</p>
          ...
          <div className="user-email flex items-center my-3 gap-5">
            <p style={{ minWidth: '120px', textAlign: 'left' }}>
              Email Address :
            </p>
